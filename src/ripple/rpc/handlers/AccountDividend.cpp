...
/*
    ...
    if (dividendSLE)
    {
        ...
        if (!txns.empty ())
        {
            ...
            result["DividendCoinsXRS"] = to_string (txn->getFieldU64 (sfDividendCoinsXRS));
            result["DividendCoinsXRSRank"] = to_string (txn->getFieldU64 (sfDividendCoinsXRSRank));
            result["DividendCoinsXRSSprd"] = to_string (txn->getFieldU64 (sfDividendCoinsXRSSprd));
...
*/
    ...
    result["DividendCoinsXRS"] = "0";
    result["DividendCoinsXRSRank"] = "0";
    result["DividendCoinsXRSSprd"] = "0";
