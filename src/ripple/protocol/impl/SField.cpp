...
SF_U32 const sfQuantumUpdatedTime   = make::one<SF_U32::type>(&sfQuantumUpdatedTime,   STI_UINT32, 128, "QuantumUpdatedTime");
SF_U32 const sfQuantumHighWeight    = make::one<SF_U32::type>(&sfQuantumHighWeight,    STI_UINT32, 129, "QuantumHighWeight");
SF_U32 const sfQuantumLowWeight    = make::one<SF_U32::type>(&sfQuantumLowWeight,    STI_UINT32, 130, "QuantumLowWeight");
SF_U32 const sfQuantumLinksCount    = make::one<SF_U32::type>(&sfQuantumLinksCount,    STI_UINT32, 131, "QuantumLinksCount");
SF_U32 const sfQuantumHighRefresh    = make::one<SF_U32::type>(&sfQuantumHighRefresh,    STI_UINT32, 132, "QuantumHighRefresh");
SF_U32 const sfQuantumLowRefresh    = make::one<SF_U32::type>(&sfQuantumLowRefresh,    STI_UINT32, 133, "QuantumLowRefresh");
...
SF_U64 const sfQuantumCoins     = make::one<SF_U64::type>(&sfQuantumCoins,    STI_UINT64, 128, "QuantumCoins");
SF_U64 const sfQuantumAccounts  = make::one<SF_U64::type>(&sfQuantumAccounts, STI_UINT64, 129, "QuantumAccounts");
...
SF_Account const sfHighAccount = make::one<SF_Account::type>(&sfHighAccount, STI_ACCOUNT, 128, "HighAccount");
SF_Account const sfLowAccount  = make::one<SF_Account::type>(&sfLowAccount,  STI_ACCOUNT, 129, "LowAccount");
SF_Account const sfDividendMarker  = make::one<SF_Account::type>(&sfDividendMarker,  STI_ACCOUNT, 130, "DividendMarker");
