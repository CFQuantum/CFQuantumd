...
LedgerFormats::LedgerFormats ()
{
    add ("AccountRoot", ltACCOUNT_ROOT)
			...
			<< SOElement (sfBalanceXRS,          SOE_OPTIONAL)
    ...
    add ("Dividend", ltDIVIDEND)
            ...
            << SOElement (sfDividendState,       SOE_OPTIONAL)    // dividend state
    ...
    add("QuantumLink", ltQUANTUM_LINK)
            << SOElement (sfHighAccount,         SOE_REQUIRED)
            << SOElement (sfLowAccount,          SOE_REQUIRED)
            << SOElement (sfQuantumHighWeight,   SOE_REQUIRED)
            << SOElement (sfQuantumLowWeight,    SOE_REQUIRED)
            << SOElement (sfQuantumHighRefresh,  SOE_REQUIRED)
            << SOElement (sfQuantumLowRefresh,   SOE_REQUIRED)
            ;
}
