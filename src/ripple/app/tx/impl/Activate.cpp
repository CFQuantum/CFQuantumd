...
TER
Activate::preflight (PreflightContext const& ctx)
{
...
TER
Activate::preclaim (PreclaimContext const& ctx)
{
...
Activate::doApply ()
{
    auto& tx = ctx_.tx;
    // reference
    AccountID const dstAccountID (tx.getAccountID (sfDestination));
