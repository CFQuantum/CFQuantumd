...
public:
    ...
    */
    ...
    Ledger (uint256 const& parentHash, uint256 const& transHash,
            ...
            std::uint64_t totDrops, std::uint64_t totDropsXRS, std::uint32_t closeTime,
    ...
    */
    ...
    void
    rawCreateXRS (XRPAmount const& drops) override
    {
        info_.dropsXRS += drops;
    }
    ...
    void setTotalDropsXRS (std::uint64_t totDropsXRS)
    {
